 ...
 *  Users page (Admins), Change password, and Log out at the very bottom. */
export function AccountMenu() {
  ...
  return (
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" sideOffset={10} className="min-w-[242px] p-0">
          ...
          <div className="p-1">
            ...
            <DropdownMenuItem className={ITEM_CLASS} onSelect={() => setChangingPassword(true)}>
      ...
      {/* A sibling of the menu, not inside it: the menu has closed by the
      ...
      <ChangePasswordDialog
        ...
        onChanged={() => {
          ...
          showToast("Password changed. Other browsers you were signed in on are signed out.");
        }}
      />
    </>
  );
