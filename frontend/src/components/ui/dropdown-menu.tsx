...
export const DropdownMenuSelection = {
  NONE: false,
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-start rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none transition-colors",
  ...
  >
    <span
      className={cn(
        "absolute left-2 top-2 flex h-4 w-4 items-center justify-center rounded border border-popover-border",
        checked === DropdownMenuSelection.PARTIAL &&
    ...
    >
      <DropdownMenuPrimitive.ItemIndicator>
        {checked === DropdownMenuSelection.PARTIAL ? (
          ...
          <Check className="h-4 w-4 text-popover-foreground bg-primary rounded" />
        )}
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
